...
// import logoImage from "@assets/교환마켓 로고-Photoroom_1756705275209.png";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-6">
        {/* 로고 */}
        <div className="mb-20">
          <div className="w-40 h-20 bg-blue-600 rounded-2xl flex items-center justify-center">
            <h1 className="text-white text-2xl font-bold">교환마켓</h1>
          </div>
        </div>
        ...
        <div className="w-full max-w-sm space-y-4">
          ...
          <Button 
            ...
            className="w-full h-14 bg-white hover:bg-gray-50 text-gray-800 border border-gray-300 text-base font-medium rounded-xl flex items-center justify-center gap-3"
            variant="outline"
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24">
          ...
          <Button 
            ...
            className="w-full h-14 bg-[#03C75A] hover:bg-[#02B350] text-white text-base font-medium rounded-xl flex items-center justify-center gap-3"
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24">
